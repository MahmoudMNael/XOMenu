...
class XOBoardPyramic: public Board{
public:
	XOBoardPyramic ();
	bool update_board (int x, int y, char mark);
	void display_board();
...
class X_O_Board_5x5:public Board{
public:
	int ptsX=0,ptsO=0;
	X_O_Board_5x5();
	bool update_board (int x, int y, char mark);
...
private:
	...
	X_O_Board_5x5* boardPtr;
	Player* players[2];
public:
	GameManager_5x5(X_O_Board_5x5 *bPtr, Player **playerPtr);
	void run();
};
class X_O_Board_4:public Board{
public:
	X_O_Board_4();
	bool update_board (int x, int y, char mark);
	void display_board();
